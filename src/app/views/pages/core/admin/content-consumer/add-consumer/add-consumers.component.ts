...
export class AddConsumersComponent{
        ...
        consumerForm = new FormGroup({
            ...
            caMobile: new FormControl('', [Validators.required,Validators.pattern(MOBILE_REGEX)]),
                highestQulification: new FormGroup({
                    highest_quali: new FormControl,
                    highest_uni: new FormControl,
                    highest_grade: new FormControl,
                    highest_Country: new FormControl,
                    highest_Year: new FormControl
                }),
